...
To compile, you must have a supported compiler installed on your system.  The Mathworks web site at http://www.mathworks.com/support/compilers lists several options.
Next you must select the desired compiler in setup.

>> mex -setup

Finally you should compile and link everything together.  Assuming all source and header files are together in the same directory, just list them all as arguments to the mex command.
...
The file demo.m shows how to run each of the algorithms described in the paper.
